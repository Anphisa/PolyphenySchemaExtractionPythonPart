...
async def build_dataframes(message):
...
async def dataframe_valentine_compare(dataframes, valentine_method):
...
async def consumer(message):
    ...
    if d_message["topic"] == "namespaceInfo":
        dfs = build_dataframes(d_message)
        matches = dataframe_valentine_compare(await dfs, Coma())
